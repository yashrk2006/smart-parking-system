...
CREATE TABLE IF NOT EXISTS vehicle_events (
    ...
    event_type TEXT NOT NULL CHECK (event_type IN ('vehicle_in', 'vehicle_out')),
    camera_id TEXT,
...
CREATE INDEX IF NOT EXISTS idx_response_zone ON response_deployments(zone_id, status);
